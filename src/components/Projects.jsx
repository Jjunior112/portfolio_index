        ...
        <section className={styles.section}>
            ...
            <motion.div ref={carrossel} className={styles.projects} whileTap={{ cursor: 'grabbing' }}  >
                ...
                <motion.div className={styles.inner} drag='x' dragConstraints={{ right: 0, left: -width }}>
                    ...
                    <Project link="https://radiant-speculoos-0f3049.netlify.app/" name='News Homepage' title="link para homepage de noticias" src='https://jjunior112.github.io/imagens/news-homepage.png' alt='news hompage'
